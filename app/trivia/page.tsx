            ...
            <div className="text-center py-6">
              ...
              <div className="grid grid-cols-3 gap-2">
                {([
                  ...
                  <div key={l.name} className="rounded-xl bg-white border border-[#e2ddd6] p-3 shadow-sm">
                    <div className="w-8 h-8 rounded-full bg-amber-50 border border-amber-200/70 flex items-center justify-center mb-2">
                      <div className="w-4 h-4 text-amber-600">{l.icon}</div>
                    </div>
              ...
              <div className="bg-[#faf9f6] border border-[#e2ddd6] rounded-xl p-3">
                ...
                {ownedCards.length === 0 ? (
                  ...
                  >
                    {selectedPhoneCard ? `Selected: ${selectedPhoneCard.player.name}` : 'Choose a Card →'}
                  </button>
                )}
              </div>
              ...
              <div className="flex gap-2">
                ...
                {(() => {
                  ...
                  return (
                    ...
                    >
                      <div className={`w-7 h-7 rounded-full flex items-center justify-center ${used ? 'bg-[#f0ede8]' : 'bg-amber-50 border border-amber-200/70'}`}>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className={`w-3.5 h-3.5 ${used ? 'text-[#c8c2b8]' : 'text-amber-600'}`}>
                          <line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/>
                        </svg>
                      </div>
                      <span className={`text-[9px] font-black ${used ? 'text-[#c8c2b8]' : 'text-[#1a1714]'}`}>50 / 50</span>
                    </button>
                  )
                })()}
                {/* Ask Coach */}
                {(() => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className={`text-[9px] font-black ${used ? 'text-[#c8c2b8]' : 'text-[#1a1714]'}`}>Ask Coach</span>
                    </button>
                  )
                })()}
                {/* Phone a Player */}
                  ...
                  return (
                    <div className="flex-1 flex flex-col">
                      <button
                        ...
                        className={`w-full flex flex-col items-center gap-1.5 px-2 py-2.5 rounded-xl border transition-all ${
                          used
                            ? 'opacity-50 cursor-not-allowed border-transparent bg-transparent'
                            : 'bg-white border-[#e2ddd6] hover:border-amber-400/50 hover:bg-amber-50/40 active:scale-[0.97] shadow-sm'
                        }`}
                      >
                        <div className={`w-7 h-7 rounded-full flex items-center justify-center ${
                          used ? 'bg-[#f0ede8]' : noCard ? 'bg-white border border-dashed border-amber-300' : 'bg-amber-50 border border-amber-200/70'
                        }`}>
                          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" className={`w-3.5 h-3.5 ${used ? 'text-[#c8c2b8]' : noCard ? 'text-amber-400' : 'text-amber-600'}`}>
                            <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.15 12 19.79 19.79 0 0 1 1.08 3.4 2 2 0 0 1 3.05 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/>
                          </svg>
                        </div>
                        <span className={`text-[9px] font-black truncate ${used ? 'text-[#c8c2b8]' : noCard ? 'text-[#a39890]' : 'text-[#1a1714]'}`}>
                          {used ? 'Phone' : noCard ? 'Pick card' : selectedPhoneCard!.player.name.split(' ').slice(-1)[0]}
                        </span>
                      </button>
                      {selectedPhoneCard && !used && (
                        <p className="text-[7px] text-red-500/60 text-center mt-0.5 leading-tight">Card burns on a miss</p>
                      )}
                    </div>
                  )
                })()}
